...
author: Felipe Arce
description: Apuntes de Lectura Comprensiva sobre texto y discurso, comunicación, resumen, síntesis, subrayado, toma de apuntes, bibliografía, citas, notas al pie y macroestructura.
image:
  url: '/ApunteLecturaComprensiva.avif'
  alt: 'ApunteLecturaComprensiva'
pubDate: 2024-01-10
tags: ['Apuntes', 'LecturaComprensiva','CursoDeIngreso']
downloadUrl: '/Lectura_Comprensiva.pdf'
totalTimeClass: 16
totalExam: 4
totalTime: 20
order: 0
professor: Adriana Kravacek
---
...
<h3 class="uppercase">Superestructura argumentativa</h3>
...
<h3 class="uppercase">Sintesís de textos argumentativos</h3>
...
<div>
  ...
  <p class="p-2 border-black border-double border-4 text-center bg-white">
