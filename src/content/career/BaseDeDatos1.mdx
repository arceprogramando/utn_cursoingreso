...
author: Felipe Arce
description: Apunte de Base de Datos I, abordando la evolución histórica, modelos de bases de datos y diseño. ¡Aprende conceptos fundamentales para tu formación en 2025! # De 150 a 160 caracteres
image:
  url: '/ApunteBaseDeDatos1.avif'
  alt: 'Apunte de Base De Datos 1'
pubDate: 2024-08-16
...
<Image 
  src="/BaseDeDatosEstructuraJerargica.avif" 
  alt="Imagen de Una Estructura Jerárquica" 
  decoding="async" 
  width={400} 
  height={400} 
  densities={[1.5, 2]} 
  class="max-w-88 md:max-w-80 my-1 rounded-md" 
/>
...
<Image 
  src="/BaseDeDatosEstructuraDeRed.avif" 
  alt="Imagen de Una Estructura De red" 
  decoding="async" 
  width={800} 
  height={800} 
  densities={[1.5, 2]} 
  class="max-w-88 md:max-w-[600px] my-1 rounded-md" 
/>
...
<figure>
  <Image 
    src="/BaseDeDatosEstructuraRelacional.avif" 
    alt="Imagen de Una Estructura Relacional" 
    decoding="async" 
    width={400} 
    height={400} 
    densities={[1.5, 2]} 
    class="max-w-88 md:max-w-96 my-1 rounded-md" 
  />
  <figcaption>
...
<Image 
  src="/BaseDeDatosEstructuraOrientadaAObjetos.avif" 
  alt="Imagen de Una Estructura Orientada a Objetos" 
  decoding="async" 
  width={400} 
  height={400} 
  densities={[1.5, 2]} 
...
<figure>
  <Image 
    src="/BaseDeDatosEstructuraConFicheros.avif" 
    alt="Imagen de Una Estructura Con Ficheros" 
    decoding="async" 
    width={500} 
    height={500} 
    densities={[1.5, 2]} 
    class="max-w-88 md:max-w-[500px] my-1 rounded-md" 
  />
  <figcaption>
...
<figure>
  <Image 
    src="/BaseDeDatosEstructuraRelacionalAcomodada.avif" 
    alt="Imagen de Una Estructura Con Ficheros" 
    decoding="async" 
    width={500} 
    height={500} 
...
<figure>
  <Image 
    src="/PeterCheen.avif" 
    alt="Introductor del modelo Entidad Relación" 
    decoding="async" 
    width={300} 
    height={300} 
    densities={[1.5, 2]} 
...
<Image 
  src="/BaseDeDatosSimbolosEntidadRelacion.avif" 
  alt="Símbolos Entidad Relación" 
  decoding="async" 
  width={300} 
  height={300} 
  densities={[1.5, 2]} 
...
<figure>
  <Image 
    src="/BaseDeDatosDiagramaBinario.avif" 
    alt="Diagrama Binario" 
    decoding="async" 
    width={500} 
    height={500} 
    densities={[1.5, 2]} 
...
<figure>
  <Image 
    src="/BaseDeDatosDiagramaGradoTres.avif" 
    alt="Diagrama Grado Tres" 
    decoding="async" 
    width={300} 
    height={300} 
    densities={[1.5, 2]} 
...
<figure>
  <Image 
    src="/BaseDeDatosDiagramaReflexivo.avif" 
    alt="Diagrama Reflexivo" 
    decoding="async" 
    width={300} 
    height={300} 
    densities={[1.5, 2]} 
...
<figure>
  <Image 
    src="/BaseDeDatosUnoAUno.avif" 
    alt="Diagrama Uno a Uno" 
    decoding="async" 
    width={300} 
    height={300} 
    densities={[1.5, 2]} 
...
<figure>
  <Image 
    src="/BaseDeDatosUnoAVarios.avif" 
    alt="Diagrama Uno a Varios" 
    decoding="async" 
    width={300} 
    height={300} 
    densities={[1.5, 2]} 
...
<figure>
  <Image 
    src="/BaseDeDatosVariosAUno.avif" 
    alt="Diagrama Varios a Uno" 
    decoding="async" 
    width={300} 
    height={300} 
    densities={[1.5, 2]} 
...
<figure>
  <Image 
    src="/BaseDeDatosVariosAVarios.avif" 
    alt="Diagrama Varios a Varios" 
    decoding="async" 
    width={300} 
    height={300} 
    densities={[1.5, 2]} 
