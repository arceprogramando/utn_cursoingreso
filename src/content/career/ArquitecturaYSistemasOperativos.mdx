...
author: Felipe Arce
description : Explora Arquitectura y Sistemas Operativos, una materia clave para aprender sobre Linux, sistemas de archivos, usuarios, permisos y otros conceptos en 2025. # de 150 y 160 
image:
  url: '/ApunteArquitecturaYSistemasOperativos.avif'
  alt: 'Apunte de Arquitectura y Sistemas Operativos'
pubDate: 2024-04-28
tags: ['Apuntes', 'ArquitecturaYSistemasOperativos','PrimerCuatrimestre']
totalTimeClass: 56
totalExam: 8
totalTime: 64
