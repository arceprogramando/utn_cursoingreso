...
<div class="bg-white p-6 rounded-lg shadow-md">
    <h2 class="text-2xl font-bold mb-4">Reflexiones sobre el Aprendizaje en Programación I</h2>
    <div class="flex flex-col m-0 p-0">
        <p>A pesar de todos los problemas mencionados, se lograron aprender algunos conceptos fundamentales en la materia. Vimos cómo funciona el lenguaje C, explorando sus características esenciales y su sintaxis. Aprendimos que en C, los <strong>strings</strong> son cadenas de caracteres, lo que significa que se representan como arreglos de caracteres terminados en un carácter nulo (<code>'\0'</code>). Esto es crucial para el manejo de texto en programas, ya que proporciona la base para funciones de entrada y salida de datos.</p>
        
        <p>Estudiamos punteros, lo que nos permitió entender la gestión de memoria y la manipulación de datos a nivel más bajo. Aprendimos a declarar punteros y cómo usarlos para acceder a las direcciones de memoria de las variables, lo que es esencial para comprender cómo funcionan las estructuras de datos en C. También exploramos el concepto de <strong>tipos de datos</strong>, incluyendo enteros, flotantes y caracteres, y cómo se comportan en términos de almacenamiento y operaciones.</p>
            
        <p>Leímos sobre el <strong>garbage collector</strong> en C, aunque es un tema que no se aplica de la misma manera que en otros lenguajes de programación, lo que nos ayudó a entender la importancia de la gestión de memoria y la liberación de recursos. Además, realizamos diagramas en papel con bastante frecuencia, lo que facilitó la visualización de la lógica detrás de nuestros programas. Estas prácticas nos enseñaron cómo se escriben e importan módulos, y cómo estructurar nuestro código de manera más eficiente.</p>
        
        <p>Aunque la experiencia en general no fue la mejor, estas lecciones fueron útiles y proporcionaron una base sólida para futuras asignaturas como lo fue la introducción a C# en Programación II.</p>
